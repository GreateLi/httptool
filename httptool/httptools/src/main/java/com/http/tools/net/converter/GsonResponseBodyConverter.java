...
package com.http.tools.net.converter;

import com.google.gson.TypeAdapter;
import com.http.tools.net.common.BasicResponse;
import com.http.tools.net.exception.NoDataExceptionException;
import com.http.tools.net.exception.ServerResponseException;
